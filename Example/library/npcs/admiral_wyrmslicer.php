...
<h2>Admiral Wyrmslicer</h2>
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=132&b=0&c=19&d=113&e=112&f=114&h=3');"></div>
	</div>
	<div class="npc-greetings">"Greetings, PLAYERNAME. Have you anything to report?"</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32396,32821,4,3&e=;32821,32396,4,9&no_buttons=1"></iframe>
