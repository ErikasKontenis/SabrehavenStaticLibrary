...
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=152&b=3&c=77&d=113&e=132&f=94&h=3');"></div>
	</div>
	<div class="npc-greetings">"Hehe. That's a good show, PLAYERNAME, with all the pyro effects. You got my attention. For a minute or so."</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32077,32533,10,3&e=;32533,32077,10,9&no_buttons=1"></iframe>
