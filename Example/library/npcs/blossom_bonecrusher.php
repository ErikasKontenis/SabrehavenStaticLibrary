...
<h2>Blossom Bonecrusher</h2>
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=139&b=0&c=96&d=19&e=63&f=95&h=3');"></div>
	</div>
	<div class="npc-greetings">"LONG LIVE THE QUEEN!"</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32390,31787,8,3&e=;31787,32390,8,9&no_buttons=1"></iframe>
