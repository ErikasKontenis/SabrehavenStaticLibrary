...
<h2>Captain Greyhound</h2>
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=129&b=0&c=96&d=113&e=95&f=115&h=3');"></div>
	</div>
	<div class="npc-greetings">"Welcome on board, Sir PLAYERNAME."</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32388,31822,7,3&e=;31822,32388,7,9&no_buttons=1"></iframe>
