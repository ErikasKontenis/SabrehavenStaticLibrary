...
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=157&b=1&c=38&d=97&e=115&f=95&h=3');"></div>
	</div>
	<div class="npc-greetings">"Ah, welcome! Welcome PLAYERNAME! If you need druid spells, you've come to the right place. Otherwise it's just nice to have a visitor."</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32268,32841,8,3&e=;32841,32268,8,9&no_buttons=1"></iframe>
