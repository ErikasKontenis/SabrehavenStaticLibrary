...
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=136&b=0&c=77&d=9&e=86&f=131&h=3');"></div>
	</div>
	<div class="npc-greetings">"Wow! A human? Here? Hey? Where do you come from, PLAYERNAME? Oh, I'm so excited!"</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=33101,32520,4,3&e=;32520,33101,4,9&no_buttons=1"></iframe>
