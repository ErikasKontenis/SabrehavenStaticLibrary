...
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=70&b=0&c=0&d=0&e=0&f=0&h=3');"></div>
	</div>
	<div class="npc-greetings">"Hiho, fellow knight PLAYERNAME!"</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32617,31938,9,3&e=;31938,32617,9,9&no_buttons=1"></iframe>
