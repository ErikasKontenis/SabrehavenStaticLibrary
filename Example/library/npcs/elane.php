...
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=137&b=2&c=113&d=63&e=120&f=119&h=3');"></div>
	</div>
	<div class="npc-greetings">"Hi, PLAYERNAME! What can I do for you?"</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32343,32239,8,3&e=;32239,32343,8,9&no_buttons=1"></iframe>
