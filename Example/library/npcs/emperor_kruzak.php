...
<h2>Emperor Kruzak</h2>
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=66&b=0&c=0&d=0&e=0&f=0&h=3');"></div>
	</div>
	<div class="npc-greetings">"Hiho, may Fire and Earth bless you, my child."</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32627,31923,4,3&e=;31923,32627,4,9&no_buttons=1"></iframe>
