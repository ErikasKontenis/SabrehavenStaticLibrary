...
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/itemSprites_792/3114.png');"></div>
	</div>
	<div class="npc-greetings">"Beeee Greeeeted PLAYERNAME. What is your neeeed?"</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32971,32080,7,3&e=;32080,32971,7,9&no_buttons=1"></iframe>
