...
<h2>Harkath Bloodblade</h2>
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=131&b=0&c=76&d=38&e=38&f=76&h=3');"></div>
	</div>
	<div class="npc-greetings">"Salutations, commoner PLAYERNAME!"</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32342,32184,8,3&e=;32184,32342,8,9&no_buttons=1"></iframe>
