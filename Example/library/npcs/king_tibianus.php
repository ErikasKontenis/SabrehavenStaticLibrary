...
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=130&b=0&c=21&d=87&e=107&f=95&h=3');"></div>
	</div>
	<div class="npc-greetings">"Long live the Tibianus!"</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32311,32171,7,3&e=;32171,32311,7,9&no_buttons=1"></iframe>
