...
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=138&b=0&c=59&d=95&e=94&f=113&h=3');"></div>
	</div>
	<div class="npc-greetings">"Welcome back, PLAYERNAME!"</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32348,31828,7,3&e=;31828,32348,7,9&no_buttons=1"></iframe>
