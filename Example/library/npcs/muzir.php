...
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=128&b=0&c=95&d=4&e=11&f=76&h=3');"></div>
	</div>
	<div class="npc-greetings">"Welcome PLAYERNAME! Daraman's blessings."</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=33222,32390,8,3&e=;32390,33222,8,9&no_buttons=1"></iframe>
