...
<h2>Percy Silverhand</h2>
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=132&b=1&c=0&d=112&e=74&f=109&h=3');"></div>
	</div>
	<div class="npc-greetings">"Greetings, PLAYERNAME."</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32330,32767,7,3&e=;32767,32330,7,9&no_buttons=1"></iframe>
