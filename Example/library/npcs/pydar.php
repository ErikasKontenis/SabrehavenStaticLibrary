...
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=160&b=0&c=95&d=94&e=132&f=118&h=3');"></div>
	</div>
	<div class="npc-greetings">"Be greeted PLAYERNAME! I can smell the scent of a phoenix on you!"</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32655,31893,12,3&e=;31893,32655,12,9&no_buttons=1"></iframe>
