...
<h2>Raymond Striker</h2>
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=151&b=1&c=58&d=77&e=60&f=114&h=3');"></div>
	</div>
	<div class="npc-greetings">"Be greeted. Is there anything I can do for you?"</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32350,32588,8,3&e=;32588,32350,8,9&no_buttons=1"></iframe>
