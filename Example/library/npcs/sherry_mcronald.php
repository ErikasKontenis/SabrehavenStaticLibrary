...
<h2>Sherry McRonald</h2>
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=136&b=0&c=78&d=94&e=38&f=58&h=3');"></div>
	</div>
	<div class="npc-greetings">"Hello PLAYERNAME! Welcome to our humble farm."</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32390,32241,8,3&e=;32241,32390,8,9&no_buttons=1"></iframe>
