...
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=138&b=0&c=60&d=92&e=90&f=95&h=3');"></div>
	</div>
	<div class="npc-greetings">"Welcome in the name of the gods, pilgrim PLAYERNAME!"</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32318,31783,8,3&e=;31783,32318,8,9&no_buttons=1"></iframe>
