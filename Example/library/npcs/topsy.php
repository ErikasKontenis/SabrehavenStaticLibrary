...
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=139&b=0&c=78&d=52&e=64&f=115&h=3');"></div>
	</div>
	<div class="npc-greetings">"Hello, dear PLAYERNAME. How can I help you?"</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32415,32170,8,3&e=;32170,32415,8,9&no_buttons=1"></iframe>
