...
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('/outfiter2/outfit.php?a=130&b=0&c=95&d=5&e=18&f=76&h=3');"></div>
	</div>
	<div class="npc-greetings">"Daraman's blessings, traveller PLAYERNAME."</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor=32537,31836,5,3&e=;31836,32537,5,9&no_buttons=1"></iframe>
