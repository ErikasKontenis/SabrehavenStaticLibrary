...
<div class="npc-profile">
	<div class="borderGuide container">
		<div class="imageT" style="background-image: url('{npcImage}');"></div>
	</div>
	<div class="npc-greetings">{npcGreetings}</div>
</div>
<div class="clear"></div>
...
<div id="foo" style="display: none;">
	<iframe id="mapper" style="width: 98%;height:800px; margin-left: auto;margin-right: auto;" src="https://www.tibiaroyal.com/apps/n_map/?lang=en&cor={npcPositionX},{npcPositionY},{npcPositionZ},3&e=;{npcPositionY},{npcPositionX},{npcPositionZ},9&no_buttons=1"></iframe>
